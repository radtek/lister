/***********************************************************************************************
*  lister - MyRichEdit.cpp
*  
*  Script Editor GUI tool for editing script text from within the right-hand pain of the main
*  app screen.  Various context menu options are supported.
*
