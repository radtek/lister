...
enum FieldRequestType {
	FRT_UpdateAll,
	FRT_UpdateChanged,
	FRT_InsertNoKey, // Key is generated by db
	FRT_Select // Only want column list, may not be any data yet anyway
};

typedef Callback1<FieldOperator&> Fields;
typedef Callback2<FieldOperator&, FieldRequestType> FieldsRequested;
